								...
								Hsps: []Hsp{
									{
										...
										AlignLen:       intPtr(23),
										Density:        nil,
										QuerySeq:       stringPtr("TGTCGAACTATACGACGAGCACT"),
										SubjectSeq:     stringPtr("TGTCGAGCTATACGACGAGCACT"),
								...
								Hsps: []Hsp{
									{
										...
										AlignLen:       intPtr(18),
										Density:        nil,
										QuerySeq:       stringPtr("ACAGAATGTCGAACTATA"),
										SubjectSeq:     stringPtr("ACAGAATGTCGAACTATA"),
										FormatMidline:  stringPtr("||||||||||||||||||"),
									},
								},
							},
								...
								Hsps: []Hsp{
									{
										...
										AlignLen:       intPtr(16),
										Density:        nil,
										QuerySeq:       stringPtr("ACTATACGACGAGCAC"),
										SubjectSeq:     stringPtr("ACTATACGACGAGCAC"),
										FormatMidline:  stringPtr("||||||||||||||||"),
									},
								},
							},
								...
								Hsps: []Hsp{
									{
										...
										AlignLen:       intPtr(16),
										Density:        nil,
										QuerySeq:       stringPtr("ACAGAATGTCGAACTA"),
										SubjectSeq:     stringPtr("ACAGAATGTCGAACTA"),
										FormatMidline:  stringPtr("||||||||||||||||"),
									},
									{
										N:              2,
										...
										AlignLen:       intPtr(16),
										Density:        nil,
										QuerySeq:       stringPtr("AGAATGTCGAACTATA"),
										SubjectSeq:     stringPtr("AGAATGTCGAACTATA"),
										FormatMidline:  stringPtr("||||||||||||||||"),
									},
								},
							},
								...
								Hsps: []Hsp{
									{
										...
										AlignLen:       intPtr(16),
										Density:        nil,
										QuerySeq:       stringPtr("CTATACGACGAGCACT"),
										SubjectSeq:     stringPtr("CTATACGACGAGCACT"),
										FormatMidline:  stringPtr("||||||||||||||||"),
									},
								},
							},
